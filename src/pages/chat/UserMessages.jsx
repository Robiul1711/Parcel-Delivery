...
const UserMessages = ({ selectedConversation, onBack }) => {
        ...
        <div className="flex items-center gap-4">
          <div>
            <h2 className="font-medium md:text-lg">
              Prize Offered: <span className="font-bold">$500</span>
            </h2>
          </div>
          <div className="flex items-center gap-2">
            <button className="border rounded-full py-1 px-3 hover:bg-custom-primary hover:text-white text-sm font-medium transition duration-300 ease-in-out">
              Accept
            </button>
            <button className="border rounded-full py-1 px-3 bg-custom-primary text-white hover:bg-white hover:text-custom-primary text-sm font-medium transition duration-300 ease-in-out">
              Reject
            </button>
          </div>
        </div>
